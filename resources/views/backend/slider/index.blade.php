                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="{{ route('add_slider') }}"
                               class="btn mt-2 btn-sm btn-success mb-2">Thêm slider</a>
                            </div>
                        </div>
                                        ...
                                        @foreach ($slider as $slider)
                                            ...
                                            <tr>
                                                ...
                                                @if ($slider->slider_status==1)
                                                    ...
                                                    <td>
                                                        <a href="{{ route('unactive_slider',['id'=>$slider->slider_id]) }}" class="badge badge-success">Kích hoạt</a>
                                                    </td>
                                                @else
                                                    <td>
                                                        <a href="{{ route('active_slider',['id'=>$slider->slider_id]) }}" class="badge badge-warning">Không kích hoạt</a>
                                                    </td>
